...
/// <summary>
/// Result will be used to generate http responses
/// </summary>
public class Result : Result<Result>
{
    /// <summary>
    /// public constructor with no arg
    /// </summary>
    public Result() : base() { }

    /// <summary>
    /// protected internal constructor with status
    /// </summary>
    ...
    /// <returns>A Result</returns>
    public new static Result Invalid(ValidationException validationError)
    {
    ...
    /// <returns>A Result</returns>
    public new static Result Invalid(params ValidationException[] validationErrors)
    {
        return new Result(ResultStatus.Invalid) { ValidationErrors = new List<ValidationException>(validationErrors) };
    }
    ...
    /// <param name="validationErrors">A list of validation errors encountered</param>
    /// <returns>A Result</returns>
    public new static Result Invalid(IEnumerable<ValidationException> validationErrors)
    {
